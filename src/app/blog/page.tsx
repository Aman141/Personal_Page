  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-[60vh] px-4 py-20">
      <div className="flex flex-col items-center">
        ...
        <h1 className="text-4xl font-bold mb-2 text-center">Blog Coming Soon</h1>
        <p className="text-lg text-gray-600 dark:text-gray-300 text-center max-w-xl mb-6">
          This page is under construction. Check back soon for articles, tutorials, and insights!
        </p>
